...
<div class="wrapper">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div style="width:100%;margin-left:0px;margin:0 auto;">
     <div class="col-xs-4">
     <h2>Piano</h2>
     <p>The piano is a musical instrument played using a keyboard,[1] which is a row of keys (small levers) that the performer presses down or strikes with the fingers and thumbs of both hands. o and ensemble performances, accompaniment, and for composing and rehearsal.</p>
            <img class="img-responsive img-circle" src="img/gallery/piano.jpg" />
        </div>
        ...
        <p>The guitar is a popular musical instrument classified as a string instrument with anywhere from 4 to 18 strings, usually having 6. The modern guitar was preceded by the gittern, the vihuela, the four-course Renaissance guitar, and the five-course baroque guitar, all of which contributed to the development of the modern six-string instrument.</p>
            <img class="img-responsive img-circle" src="img/gallery/Guitar.jpg" />
        </div>
        
         <div class="col-xs-4">
           <h2>Musical  Accessories</h2>
         <p>No matter where you are in the world, we'll help you find musical instruments that fit you, your music and your style.
...
Our site appears in English, but all prices will display in your local currency. As you shop, we'll only show you items that ship to India.your music and your style.</p>
            <img class="img-responsive img-circle" src="img/gallery/accessories.jpg" />
        </div>
